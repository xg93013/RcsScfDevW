...
<html>
	<head>
		...
		<script>
			EUI.onReady(function() {
                var editInvoiceId = EUI.util.getUrlParam("id");
	...
	<body>
		...
		<div class="main_content">
			<%--<span id="waitFinHead" value="${waitFinHead}"></span>--%>
			<!--tab_list-->
			<div class="container1200">
				<ul class="tab_list">
					<li>首页</li>
					<li><a href="/avf/invoice/toWaitPage?type=enterprise">&nbsp;&gt;&nbsp;准备发票</a></li>
					<li><a href="javascript:void(0)">&nbsp;&gt;&nbsp;发票编辑</a></li>
				</ul>
			</div>
			<!--tab_list end-->
				<div class="finInvoiceHead" data=${finInvoiceHead}></div>
				<div class="finInvoiceInfos" data=${finInvoiceInfos}></div>
				<div class="batchNumber" data=${batchNumber}></div>
