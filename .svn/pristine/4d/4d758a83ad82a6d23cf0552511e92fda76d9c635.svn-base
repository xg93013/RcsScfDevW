			...
			<div class="container1200 step_content">
				<div class="wyzzk">
					...
					<div class="wyzzk_top_right fr">
						<p class="p_1"><span class="f20 lh30">发票总计(<span class="invoiceTotalNumber">${notice.invoiceTotalNumber}</span>张)：</span><br/>总金额<font class="f36 money" data="${notice.invoiceTotalMoney}"></font><font class="f16">元</font></p>
