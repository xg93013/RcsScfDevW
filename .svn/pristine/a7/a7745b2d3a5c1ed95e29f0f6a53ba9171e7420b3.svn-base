...
<%
    ...
    if(cookies!=null&&cookies.length!=0) {
        for (Cookie cookie : cookies) {
            ...
            if (cookie.getName().equalsIgnoreCase("companyCode"))
                request.setAttribute("companyCode", URLDecoder.decode(cookie.getValue(), "utf-8"));
        }
    }
%>
<html>
<head>
    ...
    <script type="text/javascript" src="/static/avf/js/newWin.js"></script>
    <title>速信融云平台</title>
        ...
        <div class="header_container">
            ...
            <div class="com_right fr mg10">
                <div class="person_info fl">
                    <a>
                        ...
                        <div class="info_name fl">
                            <p class="font14"><c:out value="${userName}"/></p>
                            <p class="font14 mg10"><c:out value="${userIdentity}"/></p>
                        </div>
                        <!--未登录状态-->
                        <b></b>
                    </a>
                ...
                <div class="person_exit fl ml10">
                    <a href="javascript:void(0)" class="exit_link font14" id="exit_login">退出</a>
                </div>
            </div>
        </div>
    </div>
