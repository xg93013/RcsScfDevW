...
public class AvfFinancingDemandController extends BaseController {
    ...
    public ResponseModel saveFinancingDemand(@CookieValue("token")String token,
                                     @RequestParam("demandHead") String demandHead,
                                     @RequestParam("rpIds") String infos) throws InvocationTargetException, IllegalAccessException {
    ...
    public String editDemand(@CookieValue("token")String token,@RequestParam("id")String id,Model model){
        ...
        String verdorDetail = this.pbmVerdorHandler.doVerdorDetail(demandHead.getSupplyCode(), token);
        model.addAttribute("verdor",verdorDetail);
    ...
    public ResponseModel updateDemand(@CookieValue("token")String token,@RequestParam("demandHead")String demandHead,@RequestParam("rpIds")String rpIds){
        this.avfFinancingDemandHandler.updateDemand(token,demandHead,rpIds);
        return ResponseModel.SUCCESS();
    }
}
