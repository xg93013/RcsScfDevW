 ...
 */
public class EnterpriseExcelBo {
    ...
    public static List exportFormat(TrackingExcelBo excelBos){
        ...
        datas.add(5, excelBos.getFinanceProportion());//excelBos.getFinanceProportion());
        datas.add(6, excelBos.getBankRate());
        datas.add(7, excelBos.getFinanceProportion());//excelBos.getFinanceProportion().multiply(excelBos.getBankRate()));
        ...
        datas.add(13, excelBos.getReceivablesDate());
        datas.add(14, excelBos.getReceivablesMoney());
        datas.add(15, excelBos.getLoanDate());
        datas.add(16, excelBos.getLoanMoney());
        datas.add(17, excelBos.getReceivablesDate());
        datas.add(18, excelBos.getReceivablesMoney());
        datas.add(19, excelBos.getRemarks());
        return datas;
    }
