	...
	<div class="container1200 step_content">
		...
		<div class="rz_container">
			<div class="re_con_left fl">
				<p>总共：<span class="font18 org_color">${waitNumber.totalInvoiceNumber}</span>张发票</p>
			...
			<div class="re_con_right fr">
				...
				<div class="prpare_btn fl">
					...
					<%--<a href="/avf/invoice/toAddInvoice?type=supplier"  id="input_invoice" class="orgBg">手动录入发票</a>--%>
