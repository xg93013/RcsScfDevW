...
<head>
    ...
    <script type="text/javascript" src="/static/login/js/vcode.js"></script>
...
<div class="header_com">
    <div class="container1200">
        <div class="com_left fl mg10">
            <a href="/login.jsp"><img  src="/static/avf/images/logo.png"/></a>
        </div>
    ...
    <div class="news_box container1200">
        <div class="news_box_left fl">
            ...
            <div class="news_items_box">
                ...
                <div class="news_items">
                    <a href="/news_detail.jsp">
                        <p class="news_items_img"><img src="/static/login/images/news4.jpg" /></p>
                        <p class="news_items_text">市经信委组织应收账款融资试点核心企业赴长虹公司开展业务操作观摩学习</p>
                    </a>
                </div>
                <div class="news_items noMarginRight">
                    <a href="/news_detail.jsp">
                        <p class="news_items_img"><img src="/static/login/images/news1.jpg" /></p>
                        <p class="news_items_text">浙江省经信委来绵调研应收账款融资服务试点工作</p>
                    </a>
                </div>
            </div>
        ...
        <div class="news_box_right fl">
            ...
            <ul>
                <li><a href="/news_detail.jsp"><span class="news_r_text">国家工信部人民银行调研绵阳应收账款融资服务试点工作</span><span class="news_r_date">5月2日</span></a></li>
                <li><a href="/news_detail.jsp"><span class="news_r_text">市经信委组织应收账款融资试点核心企业赴长虹公司开展业务操作观摩学习</span><span class="news_r_date">5月2日</span></a></li>
                <li><a href="/news_detail.jsp"><span class="news_r_text">浙江省经信委来绵调研应收账款融资服务试点工作</span><span class="news_r_date">5月2日</span></a></li>
                <li><a href="/news_detail.jsp"><span class="news_r_text">国家工信部人民银行调研绵阳应收账款融资服务试点工作</span><span class="news_r_date">5月2日</span></a></li>
                <li><a href="/news_detail.jsp"><span class="news_r_text">浙江省经信委来绵调研应收账款融资服务试点工作</span><span class="news_r_date">5月2日</span></a></li>
            </ul>
        </div>
