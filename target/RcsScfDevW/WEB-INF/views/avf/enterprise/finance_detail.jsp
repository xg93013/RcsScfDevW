...
<html>
	<head>
		...
		<script type="text/javascript" src="/static/avf/js/sheet_detail.js" ></script>
		<style>
		...
		<div class="main_content">
			...
			<div class="container1200 step_content">
				...
				<div class="showInfo">
					...
					<div class="show_invoice" style="<c:if test="${avfAccountsRecTraNotice.invoiceTotalNumber == 0}">display: none;</c:if>">
